...
It is the //default_server// for HTTPS and allows connections from LAN only by
including the file ''$(dirname "${CONF_DIR}")/restrict_locally'' with
//allow/deny// directives, cf. the official documentation on
